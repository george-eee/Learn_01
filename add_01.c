...
//	char a = 51;
//	char b = 58;
//	char c = a + b;//这里的+操作符两端的操作数a，b就都只是char类型 明显精度小于整型精度 所以a,b在使用前会被转换为普通整型
//	printf("%d\n", c);
//	return 0;
//}
//整型提升的意义？
...
//  //再补码加法运算：11111111111111111111111111111111
//  //再换算成原码->10000000000000000000000000000001->十进制：-1
//	printf("%d\n", c);//-1
//	return 0;
//}
